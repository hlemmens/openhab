...
public class WmrBinding extends AbstractBinding<WmrBindingProvider> implements ManagedService, IWmrListener {
    ...
    private static final Logger logger = LoggerFactory.getLogger(WmrBinding.class);

    private HIDConnector connector;

    protected void addBindingProvider(WmrBindingProvider bindingProvider) {
        super.addBindingProvider(bindingProvider);
    }

    protected void removeBindingProvider(WmrBindingProvider bindingProvider) {
    ...
    public void dataReceived(Map<String, Object> data) {
        ...
        for (WmrBindingProvider provider : providers) {
            ...
            for (Entry<String, Object> entry : data.entrySet()) {
                ...
                State state = StateUtils.convertToState(b != null ? b : entry.getValue());
